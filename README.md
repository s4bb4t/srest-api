Вот обновленная и улучшенная документация с добавленным блоком навигации и некоторыми улучшениями:
...
- **Путь**: `/admin/user/{id}/block`
- **Метод**: PUT
- **Описание**: Блокирует или разблокирует пользователя.
- **Параметры**:
  - **id** (путь): ID пользователя.
